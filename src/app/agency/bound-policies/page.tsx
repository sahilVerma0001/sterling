    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Bound Policies</h1>
          <p className="text-gray-600 mt-2">
            View all your policies that have been bound and approved
          </p>
        </div>
        ...
        {policies.length === 0 ? (
          <div className="bg-white rounded-lg shadow p-8 text-center">
            <p className="text-gray-600">
              No bound policies found. Policies will appear here after they are approved by admin.
            </p>
          </div>
        ) : (
            ...
            {policies.map((policy) => (
              ...
              >
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                  <Link
                    href={`/agency/submissions/${policy._id}`}
          ...
          <div className="mt-8 bg-white rounded-lg shadow p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                <p className="text-sm text-gray-600">Total Coverage Value</p>
