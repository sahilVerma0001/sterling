...
export default function AgencyDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <aside className="w-[70px] bg-[#3A3C3F] flex flex-col items-center py-6 fixed h-full z-50 border-r border-gray-700">
        ...
        <div className="flex flex-col gap-4 mt-auto">
          ...
          <Link href="/agency/marketplace" className="p-3 text-gray-400 hover:text-white hover:bg-[#4DD0E1]/10 rounded-lg transition-colors">
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
            </svg>
          </Link>
          <div className="text-[10px] text-gray-400 text-center -mt-2">Market</div>
        </div>
      </aside>
